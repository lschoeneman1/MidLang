...
namespace MidLang.Stage2
{
    ...
    /// 
    /// Stage 2 adds support for strings and characters.
    /// 
    ...
    class Program
    {
        static void Main(string[] args)
        {
            if (args.Length == 0)
            {
                Console.WriteLine("Usage: MidLang.Stage2 <source_file.mid>");
                Console.WriteLine("Example: MidLang.Stage2 examples/stage2_example1.mid");
                return;
            }
