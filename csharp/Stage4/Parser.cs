...
namespace MidLang.Stage4
{
    ...
    public class Parser
    {
        ...
        /// <summary>
        /// Parses a statement (var declaration, assignment, print, println, if, or while).
        /// Statement = VarDeclarationStatement | AssignmentStatement | PrintStatement | PrintLineStatement | IfStatement | WhileStatement
        /// </summary>
